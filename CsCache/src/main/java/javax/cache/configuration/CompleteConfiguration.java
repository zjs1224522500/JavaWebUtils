 ...
 * {@link CompleteConfiguration}s are often compared at
 * runtime.
 *
...
public interface CompleteConfiguration<K, V> extends Configuration<K, V>,
  ...
  /**
   * Gets the {@link Factory} for the
   * {@link CacheLoader}, if any.
   * <p>
   ...
   * {@link CacheLoader} or null if none has been set.
   */
  Factory<CacheLoader<K, V>> getCacheLoaderFactory();

  /**
   * Gets the {@link Factory} for the
   * {@link CacheWriter}, if any.
   * <p>
   * The default value is <code>null</code>.
   *
   * @return the {@link Factory} for the
   * {@link CacheWriter} or null if none has been set.
   */
  Factory<CacheWriter<? super K, ? super V>> getCacheWriterFactory();

  /**
   * Gets the {@link Factory} for the
   * {@link ExpiryPolicy} to be used for caches.
   * <p>
   * The default value is a {@link Factory} that will
   * produce a {@link javax.cache.expiry.EternalExpiryPolicy} instance.
   *
   * @return the {@link Factory} for
   * {@link ExpiryPolicy} (must not be <code>null</code>)
   */
